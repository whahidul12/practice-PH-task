...
const Footer = () => {
  return (
    ...
    //   <footer className="footer sm:footer-horizontal text-base-content mx-auto max-w-7xl border-2 p-10">
      ...
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          ...
          <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
            <div className="">
              <p className="text-deutziawhite font-inter text-[18px] leading-normal font-medium">
                Pages
              </p>
              <ul>
        ...
        <div className="flex items-center justify-center pt-[9px] pb-8 md:py-8">
